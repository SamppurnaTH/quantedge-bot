...
| :--- | :--- | :--- | :--- |
| **Nifty 50** | -0.13% | +0.14% | RANGE-BOUND |
| **Bank Nifty** | -0.16% | — | — |
...
- ✗ Directional Bias: Predicted BULLISH, Market closed NEUTRAL (Nifty -0.13%)
- ✗ Opening Gap: Predicted High Gap Up Probability, Actual open was GAP-UP (+0.14%)

**Yesterday's EOD Prediction Score:** ❌ FAILED
- Yesterday's Forecast: *Range-Bound Consolidation Likelihood Elevated*
- Today's Actual Nifty Change: -0.13%
...
- **Smart Money:** Unusual volume detected in INDUSINDBK.NS, TITAN.NS.
- **Weakness:** Breakout failures occurred in HDFCBANK.NS.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **ADANIENT.NS** | SELL | ₹2739.80 | ₹3107.20 | +13.41% | +0.00R |
| **APOLLOHOSP.NS** | SELL | ₹8430.00 | ₹8837.00 | +4.83% | +0.00R |
| **GRASIM.NS** | SELL | ₹3180.00 | ₹3190.90 | +0.34% | +0.00R |
| **POWERGRID.NS** | BUY | ₹298.50 | ₹284.35 | -4.74% | -1.06R |
| **NTPC.NS** | BUY | ₹391.95 | ₹354.20 | -9.63% | -2.37R |
...
| :--- | :--- |
| 🟢 Bullish Continuation | **29.9%** |
| 🟡 Sideways / Range-Bound | **34.5%** |
| 🔴 Bearish Continuation | **35.6%** |
